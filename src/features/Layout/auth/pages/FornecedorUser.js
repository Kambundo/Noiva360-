...
function Cadastro() {
        ...
        <div className='cadastro-gp c-gp1'>
           ...
           <div className='text-postion-absolute'>
                ...
                {/* <div className='slogan-noiva360'>Transformando sonhos em realidade!! </div> */}
                    ...
                    <div className='sim-quero'>Conecte-se com casais apaixonados e expanda suas oportunidades de negócio com o Noiva 360º</div>
                    <div className='organizar-casamento'>A plataforma ideal para fornecedores de casamento!</div>
                </div>
            </div>
 ...
 <div className='inputBox'>
                    ...
                    <div className='btn-cadastro'>Entrar</div>
                    <div className='possui-conta'><Link to={'/auth/fornecedores/multi'}>Criar Conta</Link> </div>
                </div>
